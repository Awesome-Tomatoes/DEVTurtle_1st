...
<table class="datatable-table">
    <tbody>
        ...
        <tr>
            <th>제목</th>
            <td><input type="text" name="title" size="80" value="${MY_KEY_BVO_RLIST.title}"></td>
        </tr>
        <tr>
            <th>글쓴이</th>
        ...
        <tr>
            <th>내용</th>
            <td><textarea name="contents" rows="5" cols="100">${MY_KEY_BVO_RLIST.contents}</textarea></td>
        </tr>
    </tbody>
    <tfoot>
    	<tr>
...
<c:choose>
	...
	<c:otherwise> 
				...
				<c:forEach var="rvo" items="${MY_KEY_BVO_RLIST.rlist}">
					<tr>
						<td>
